...
/**
 * Zombie Crush Saga is a game application that's ready to be customized
...
public class ZombieCrushSaga
{
    ...
    public enum ZombieCrushSagaPropertyType
    {
        ...
        TOOLBAR_IMAGE_NAME,
        SCROLL_UP_IMAGE_NAME,
        SCROLL_UP_MOUSE_OVER_IMAGE_NAME,
        SCROLL_DOWN_IMAGE_NAME,
        SCROLL_DOWN_MOUSE_OVER_IMAGE_NAME,
        LIVES_IMAGE_NAME,
        LEVEL_IMAGE_NAME,
