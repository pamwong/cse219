...
public class ZombieCrushSagaConstants
{
    ...
    // SPLASH SCREEN UI CONTROL TYPES
    ...
    public static final int RESET_BUTTON_X = PLAY_BUTTON_X + SPLASH_SCREEN_MARGIN;
    public static final int RESET_BUTTON_Y = 500;
    public static final int QUIT_BUTTON_X = RESET_BUTTON_X + SPLASH_SCREEN_MARGIN;
    public static final int QUIT_BUTTON_Y = 500;
