...
public class ZombieCrushSagaDataModel extends MiniGameDataModel
{
    ...
    private ZombieCrushSagaTile badSelectedTile;
    ...
    public void selectTile(ZombieCrushSagaTile selectTile)
    {
        ...
        else miniGame.getAudio().play(ZombieCrushSagaPropertyType.NO_MATCH_AUDIO_CUE.toString(), false);     
    ...
    public void reset(MiniGame game)
    {
        ...
        game.getAudio().play(ZombieCrushSagaPropertyType.GAMEPLAY_SONG_CUE.toString(), true);
